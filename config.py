...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002149472838")) #Your db channel Id
OWNER = os.environ.get("OWNER", "xenosupport") # Owner username without @
OWNER_ID = int(os.environ.get("OWNER_ID", "6660736046")) # Owner id
#--------------------------------------------
